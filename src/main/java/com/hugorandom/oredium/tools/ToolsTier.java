...
public class ToolsTier {
    ...
    public static final ForgeTier DISPROSIO = new ForgeTier(4, 897, 6.0f, 3f, 30,
            BlockTags.NEEDS_DIAMOND_TOOL,() -> Ingredient.of(Items1Init.DISPROSIO_INGOT.get()));
    public static final ForgeTier FRANITOLINA = new ForgeTier(4, 1126, 7.5f, 4.0f, 20,
            BlockTags.NEEDS_DIAMOND_TOOL,() -> Ingredient.of(Items1Init.FRANITOLINA_INGOT.get()));
    public static final ForgeTier MELITONILA = new ForgeTier(4, 1626, 8.5f, 4.5f, 25,
            BlockTags.NEEDS_DIAMOND_TOOL,() -> Ingredient.of(Items1Init.MELITONILA_INGOT.get()));
    public static final ForgeTier TERIUM = new ForgeTier(4, 2031, 9.0f, 4f, 18,
    ...
    public static final ForgeTier HALINOX = new ForgeTier(4, 1896, 10.0f, 4.5f, 12,
